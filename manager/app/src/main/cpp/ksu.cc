...
// Do not call the KSU "install fd" reboot syscall from the app: zygote seccomp disallows
// __NR_reboot (SIGSYS on arm64). Official Manager gets [ksu_driver] via setuid hook; unofficial
// signing must add your cert to the kernel (e.g. EXPECTED_HASH2) or use CONFIG_KSU_DISABLE_MANAGER.
