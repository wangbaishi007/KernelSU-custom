...
object Natives {
    ...
    /**
     * True when the KernelSU driver answers with a positive version. The kernel only sets
     * [isManager] for the officially signed manager APK; rebuilt APKs with another signing key
     * still receive [version] if the driver is loaded.
     */
    fun isKernelReady(): Boolean = version > 0
